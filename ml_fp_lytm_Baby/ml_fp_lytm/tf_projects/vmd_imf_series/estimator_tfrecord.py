...
model_path = current_path+'\\models\\imf10\\' #===========Change here==========
...
TRAIN_DATA_FILES_PATTERN = par_path_2 + '\\data\\sample_vmdimf10_train.tfrecords' # change here
VALID_DATA_FILES_PATTERN = par_path_2 + '\\data\\sample_vmdimf10_dev.tfrecords'
TEST_DATA_FILES_PATTERN = par_path_2 + '\\data\\unsample_vmdimf10_test.tfrecords'
