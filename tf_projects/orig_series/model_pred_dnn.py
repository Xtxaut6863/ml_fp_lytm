...
def main(argv):
    ...
    current_model = 'lr0.01_ds1000_dr0.98_hu[15]_bs512_drop[0.0]'
    ...
    checkpoint_path = model_dir + 'model.ckpt-16300'
    ...
    dump_train_dev_test_to_excel(
        path=
        'F:/ml_fp_lytm/tf_projects/orig_series/models/'
        + current_model + '.xlsx',
        y_train=y_train,
