...
def plot_normreconvert_relation(records, predictions,series_mean,series_max,series_min,fig_savepath):
    """ 
    Plot the relations between the records and predictions.
    Args:
        records: the actual measured records.
...
def plot_normreconvert_pred(records, predictions,series_mean,series_max,series_min, fig_savepath):
    """
    Plot lines of records and predictions.
    Args:
        records: record data set.
