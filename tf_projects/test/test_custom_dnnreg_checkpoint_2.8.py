...
STEPS = 1000
model_path = "F:/ml_fp_lytm/tf_projects/test/models/temp2.8/"
...
def main(argv):
    ...
    my_check_point_config = tf.estimator.RunConfig(
        save_checkpoints_secs=1, #Save the checkpoints every 1 second.
        keep_checkpoint_max=50  #Retain the 50most recent checkpoints
    )
