...
STEPS = 1000
model_path = "F:/ml_fp_lytm/tf_projects/test/models/temp2.5/"
...
def main(argv):
    ...
    #         metric_fn = tf.contrib.metrics.root_mean_squared_error,prediction_key="predictions"
    #     )
    # }



    # validation_monitor = tf.contrib.learn.monitors.validation_monitor(
    #     x_dev,
    #     y_dev,
    #     every_n_steps = 50,
    ...
    model = tf.estimator.Estimator(
        ...
        config=tf.estimator.RunConfig(save_checkpoints_secs=1)
        )
