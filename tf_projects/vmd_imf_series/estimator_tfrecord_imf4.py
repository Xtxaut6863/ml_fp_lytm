...
model_path = current_path+'\\models\\imf4\\' #===========Change here==========
...
TRAIN_DATA_FILES_PATTERN = par_path_2 + '\\data\\sample_vmdimf4_train.tfrecords'
VALID_DATA_FILES_PATTERN = par_path_2 + '\\data\\sample_vmdimf4_dev.tfrecords'
TEST_DATA_FILES_PATTERN = par_path_2 + '\\data\\unsample_vmdimf4_test.tfrecords'
