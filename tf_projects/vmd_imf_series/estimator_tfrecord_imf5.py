...
model_path = current_path+'\\models\\imf5\\' #===========Change here==========
...
TRAIN_DATA_FILES_PATTERN = par_path_2 + '\\data\\sample_vmdimf5_train.tfrecords'
VALID_DATA_FILES_PATTERN = par_path_2 + '\\data\\sample_vmdimf5_dev.tfrecords'
TEST_DATA_FILES_PATTERN = par_path_2 + '\\data\\unsample_vmdimf5_test.tfrecords'
