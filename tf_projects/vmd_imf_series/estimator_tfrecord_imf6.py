...
model_path = current_path+'\\models\\imf6\\' #===========Change here==========
...
TRAIN_DATA_FILES_PATTERN = par_path_2 + '\\data\\sample_vmdimf6_train.tfrecords' # change here
VALID_DATA_FILES_PATTERN = par_path_2 + '\\data\\sample_vmdimf6_dev.tfrecords'
TEST_DATA_FILES_PATTERN = par_path_2 + '\\data\\unsample_vmdimf6_test.tfrecords'
