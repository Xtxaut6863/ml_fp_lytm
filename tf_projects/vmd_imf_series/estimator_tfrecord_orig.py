...
model_path = current_path+'\\models\\orig\\' #===========Change here==========
...
TRAIN_DATA_FILES_PATTERN = par_path_2 + '\\data\\sample_orig_train.tfrecords'
VALID_DATA_FILES_PATTERN = par_path_2 + '\\data\\sample_orig_dev.tfrecords'
TEST_DATA_FILES_PATTERN = par_path_2 + '\\data\\unsample_orig_test.tfrecords'
